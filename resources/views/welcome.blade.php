...
<body class="font-sans text-dark antialiased bg-white overflow-x-hidden w-full max-w-none m-0 p-0" x-data="{
        ...
        <div class="w-full px-4 sm:px-6 lg:px-12 xl:px-16 2xl:px-24 relative z-10">
            ...
            <div class="relative bg-white rounded-3xl shadow-xl overflow-hidden">
                ...
                <div class="absolute bottom-4 right-4 flex gap-2 z-[1000]">
                    <a href="https://www.google.com/maps/dir/?api=1&destination=12.348635936149357,-1.4894717304794114&travelmode=driving"
                       target="_blank"
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const lat = 12.348635936149357;
            const lng = -1.4894717304794114;

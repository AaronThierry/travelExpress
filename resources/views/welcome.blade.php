        ...
        <div class="w-full px-4 sm:px-6 lg:px-8">
            <nav class="flex items-center justify-between h-[70px] sm:h-[80px]">
                ...
                <div class="hidden xl:flex items-center justify-end flex-1 space-x-2">
                    ...
                    <a href="/bourse" class="flex items-center space-x-1.5 px-4 py-2 text-sm font-semibold text-white bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 rounded-lg transition-all duration-300 group shadow-md hover:shadow-lg">

...
<aside id="sidebar" class="fixed top-0 left-0 z-40 h-screen transition-all duration-300 ease-out -translate-x-full lg:translate-x-0 sidebar-width">
    ...
    <div class="relative h-full flex flex-col">
        ...
        <nav class="flex-1 px-3 pb-4 space-y-1 overflow-y-auto custom-scrollbar">
            ...
            <a href="{{ route('admin.registre') }}" class="nav-link group {{ request()->routeIs('admin.registre') ? 'active' : '' }}" title="Registre voyageurs">
                <div class="nav-icon-wrapper">
                    <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <span class="sidebar-text nav-text">Registre voyageurs</span>
            </a>

            <a href="{{ route('admin.prospections') }}" class="nav-link group {{ request()->routeIs('admin.prospections') ? 'active' : '' }}" title="Prospections terrain">
                <div class="nav-icon-wrapper">
                    <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.75" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z"/>
                    </svg>
                </div>
                <span class="sidebar-text nav-text">Prospections</span>
            </a>
        </nav>

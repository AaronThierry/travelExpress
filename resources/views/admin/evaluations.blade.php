            ...
            document.getElementById('detail-content').innerHTML = `
                ...
                <div class="p-6 space-y-6">
                    ...
                    <div class="pt-4 border-t border-gray-100 space-y-3">
                        ...
                        <button onclick="showConfirmModal('delete', ${e.id}); closeDetailModal();" class="w-full px-4 py-3 bg-gradient-to-r from-gray-600 to-gray-700 text-white font-semibold rounded-xl hover:from-gray-700 hover:to-gray-800 transition-all flex items-center justify-center gap-2 shadow-lg">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
